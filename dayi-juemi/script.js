const timelineEvents = [
  ...
  },
  {
    ...
    tags: ["文字獄", "皇位繼承", "《大義覺迷錄》相關事件"]
  },
  {
    year: "1729",
    title: "《大義覺迷錄》成書刊行",
    desc: "雍正以問答、供詞與諭旨重構正統論，將案件轉化為面向士人的政治文本。",
    tags: ["政治", "文字獄", "《大義覺迷錄》相關事件"]
  },
  {
    year: "1730",
    title: "改土歸流深入推行",
...
const textCategories = [
  ...
  },
  {
    id: "memorials",
    name: "奏摺與硃批",
    intro: "以臣工奏報與皇帝硃批的語氣、權力關係為特色。",
    items: ["田文鏡奏摺", "李衛奏摺", "鄂爾泰奏摺", "年羹堯相關奏摺", "曾靜案相關奏摺", "錢糧、鹽政、軍務、邊疆奏摺"]
  },
  {
    id: "buddhist",
    name: "佛教與禪宗文獻",
...
const keywords = {
  ...
  "硃批": ["奏摺與硃批：語氣分類、追問結構、行政責任。", "田文鏡、李衛、鄂爾泰奏摺可作首批樣本。"],
